...
'SHOW_SCENE_ITEM.VLC_SOURCE', 'HIDE_SCENE_ITEM.VLC_SOURCE', 'SHOW_SCENE_ITEM.NDI_SOURCE', 'HIDE_SCENE_ITEM.NDI_SOURCE', 'SHOW_SCENE_ITEM.COREAUDIO_OUTPUT_CAPTURE', 'HIDE_SCENE_ITEM.COREAUDIO_OUTPUT_CAPTURE',
...
'SHOW_SCENE_ITEM.DISPLAY_CAPTURE', 'HIDE_SCENE_ITEM.DISPLAY_CAPTURE'];
...
let audio_lineHotkeys: string[] = ['MUTE', 'UNMUTE', 'PUSH_TO_MUTE', 'PUSH_TO_TALK'];
export {audio_lineHotkeys};
