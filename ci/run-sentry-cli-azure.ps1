...
.\sentry-cli.exe upload-dif --org streamlabs-obs --log-level DEBUG --project obs-server "$env:ROOTDIRECTORY\syms\ascii"
.\sentry-cli.exe upload-dif --org streamlabs-obs --log-level DEBUG --project obs-server-preview "$env:ROOTDIRECTORY\syms\ascii"
.\sentry-cli.exe upload-dif --org streamlabs-obs --log-level DEBUG --project obs-client "$env:ROOTDIRECTORY\syms\ascii\client"
