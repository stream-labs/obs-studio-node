...
.\sentry-cli.exe --log-level DEBUG upload-dif --org streamlabs-obs --project obs-server "$env:ROOTDIRECTORY\syms\ascii"
.\sentry-cli.exe --log-level DEBUG upload-dif --org streamlabs-obs --project obs-server-preview "$env:ROOTDIRECTORY\syms\ascii"
.\sentry-cli.exe --log-level DEBUG upload-dif --org streamlabs-obs --project obs-client "$env:ROOTDIRECTORY\syms\ascii\client"
