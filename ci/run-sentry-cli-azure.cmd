...
for /f %%f in ('dir /b "%SLFullDistributePath%\obs-studio-node\obs-plugins\64bit\*.pdb"') do "%RootDirectory%\dump_syms.exe" %%f > "%RootDirectory%\syms\%%~nf.sym"
...
"%RootDirectory%\sentry-cli.exe" --auth-token "d6526d57bb84421eaaeff7983639897de9a0c51ab5274cf4b89d3ad3944d3cbd" upload-dif --org streamlabs-obs --project obs-server "%RootDirectory%\syms\server"
"%RootDirectory%\sentry-cli.exe" --auth-token "d6526d57bb84421eaaeff7983639897de9a0c51ab5274cf4b89d3ad3944d3cbd" upload-dif --org streamlabs-obs --project obs-server-preview "%RootDirectory%\syms\server"
"%RootDirectory%\sentry-cli.exe" --auth-token "d6526d57bb84421eaaeff7983639897de9a0c51ab5274cf4b89d3ad3944d3cbd" upload-dif --org streamlabs-obs --project obs-client "%RootDirectory%\syms\client"