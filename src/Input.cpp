...
NAN_MODULE_INIT(Input::Init)
{
	...
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "duplicate",
	                               duplicate);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "copyFilters",
	                               copyFilters);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "findFilter",
	                               findFilter);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "addFilter",
	                               addFilter);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "removeFilter",
	                               removeFilter);
	...
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "height",
	                                      get_height);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "filters",
	                                      get_filters);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "volume",
	                                      get_volume, set_volume);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "syncOffset", get_syncOffset, set_syncOffset);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "showing",
	                                      get_showing);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "audioMixers", get_audioMixers, set_audioMixers);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "monitoringType", get_monitoringType, set_monitoringType);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "deinterlaceFieldOrder", get_deinterlaceFieldOrder, set_deinterlaceFieldOrder);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "deinterlaceMode", get_deinterlaceMode, set_deinterlaceMode);
...
NAN_METHOD(Input::get_deinterlaceFieldOrder)
{
	...
	info.GetReturnValue().Set(common::ToValue(
	                                handle.get()->deinterlace_field_order()));
}
...
NAN_METHOD(Input::set_deinterlaceFieldOrder)
{
	...
	handle.get()->deinterlace_field_order(static_cast<obs_deinterlace_field_order>
	                                      (order));
}
