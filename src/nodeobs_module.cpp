...
void nodeobs_init(Local<Object> exports)
{
	...
	NODE_SET_METHOD(exports, "StartRecordingEncoderTest",
	...
	NODE_SET_METHOD(exports, "OBS_API_getPathConfigDirectory",
	                OBS_API::OBS_API_getPathConfigDirectory);
	NODE_SET_METHOD(exports, "OBS_API_setPathConfigDirectory",
	                OBS_API::OBS_API_setPathConfigDirectory);
	NODE_SET_METHOD(exports, "OBS_API_getOBS_existingProfiles",
	                OBS_API::OBS_API_getOBS_existingProfiles);
	NODE_SET_METHOD(exports, "OBS_API_getOBS_existingSceneCollections",
	                OBS_API::OBS_API_getOBS_existingSceneCollections);
	NODE_SET_METHOD(exports, "OBS_API_getOBS_currentProfile",
	                OBS_API::OBS_API_getOBS_currentProfile);
	NODE_SET_METHOD(exports, "OBS_API_setOBS_currentProfile",
	                OBS_API::OBS_API_setOBS_currentProfile);
	NODE_SET_METHOD(exports, "OBS_API_getOBS_currentSceneCollection",
	                OBS_API::OBS_API_getOBS_currentSceneCollection);
	NODE_SET_METHOD(exports, "OBS_API_setOBS_currentSceneCollection",
	                OBS_API::OBS_API_setOBS_currentSceneCollection);
	NODE_SET_METHOD(exports, "OBS_API_isOBS_installed",
	                OBS_API::OBS_API_isOBS_installed);
	NODE_SET_METHOD(exports, "OBS_API_useOBS_config",
	                OBS_API::OBS_API_useOBS_config);
	...
	NODE_SET_METHOD(exports, "OBS_service_stopStreaming",
	                OBS_service::OBS_service_stopStreaming);
	...
	NODE_SET_METHOD(exports,
	                ...
	                OBS_service::OBS_service_associateAudioAndVideoToTheCurrentStreamingContext);
	NODE_SET_METHOD(exports,
	                "OBS_service_associateAudioAndVideoToTheCurrentRecordingContext",
	                OBS_service::OBS_service_associateAudioAndVideoToTheCurrentRecordingContext);
	NODE_SET_METHOD(exports,
	                "OBS_service_associateAudioAndVideoEncodersToTheCurrentStreamingOutput",
	                OBS_service::OBS_service_associateAudioAndVideoEncodersToTheCurrentStreamingOutput);
	NODE_SET_METHOD(exports,
	                "OBS_service_associateAudioAndVideoEncodersToTheCurrentRecordingOutput",
	                OBS_service::OBS_service_associateAudioAndVideoEncodersToTheCurrentRecordingOutput);
	NODE_SET_METHOD(exports, "OBS_service_setServiceToTheStreamingOutput",
	                OBS_service::OBS_service_setServiceToTheStreamingOutput);
	...
	//OBS_settings
	NODE_SET_METHOD(exports, "OBS_settings_getListCategories",
	                OBS_settings::OBS_settings_getListCategories);
	NODE_SET_METHOD(exports, "OBS_settings_getSettings",
	                OBS_settings::OBS_settings_getSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveSettings",
	                OBS_settings::OBS_settings_saveSettings);
}
