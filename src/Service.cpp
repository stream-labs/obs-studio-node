...
Service::Service(std::string id, std::string name, obs_data_t *settings,
                 obs_data_t *hotkey)
...
NAN_MODULE_INIT(Service::Init)
{
	...
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "settings",
	                                      get_settings);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "url",
	                                      get_url);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "key",
	                                      get_key);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "username",
	                                      get_username);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "password",
	                                      get_password);
