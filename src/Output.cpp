...
Output::Output(std::string id, std::string name, obs_data_t *settings,
               obs_data_t *hotkey)
...
NAN_MODULE_INIT(Output::Init)
{
	...
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "release",
	                               release);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setMedia",
	                               setMedia);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getVideo",
	                               getVideo);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getAudio",
	                               getAudio);
	common::SetObjectTemplateField(locProto->InstanceTemplate(),
	                               "setReconnectOptions", setReconnectOptions);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setPreferredSize",
	                               setPreferredSize);
	...
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setDelay",
	                               setDelay);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getDelay",
	                               getDelay);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getActiveDelay",
	                               getActiveDelay);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getAudioEncoder",
	                               getAudioEncoder);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setAudioEncoder",
	                               setAudioEncoder);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getVideoEncoder",
	                               getVideoEncoder);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setVideoEncoder",
	                               setVideoEncoder);
	...
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "settings",
	                                      get_settings);
	...
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "id",
	                                      get_id);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "mixer",
	                                      get_mixer, set_mixer);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "service",
	                                      get_service, set_service);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "width",
	                                      get_width);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "height",
	                                      get_height);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "congestion", get_congestion);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "connectTime", get_connectTime);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "reconnecting", get_reconnecting);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "supportedVideoCodecs", get_supportedVideoCodecs);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "supportedAudioCodecs", get_supportedAudioCodecs);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "framesDropped", get_framesDropped);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "totalFrames", get_totalFrames);
