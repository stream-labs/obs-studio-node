...
NAN_MODULE_INIT(Video::Init)
{
	...
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "skippedFrames", get_skippedFrames);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
...
NAN_METHOD(Video::get_skippedFrames)
{
	info.GetReturnValue().Set(common::ToValue(
	                                obs::video::global().skipped_frames()));
}
...
NAN_MODULE_INIT(VideoEncoder::Init)
{
	...
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getVideo",
	                               getVideo);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setVideo",
	                               setVideo);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getHeight",
	                               getHeight);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "getWidth",
	                               getWidth);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "setScaledSize",
	                               setScaledSize);
...
{
	obs::weak<obs::video_encoder> &handle = VideoEncoder::Object::GetHandle(
	                                              info.Holder());
