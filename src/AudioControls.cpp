...
NAN_MODULE_INIT(Fader::Init)
{
	...
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "db",
	                                      get_db, set_db);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "deflection", get_deflection, set_deflection);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(), "mul",
	                                      get_mul, set_mul);
	...
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "addCallback",
	                               addCallback);
	common::SetObjectTemplateField(locProto->InstanceTemplate(), "removeCallback",
	                               removeCallback);
...
NAN_MODULE_INIT(Volmeter::Init)
{
	...
	common::SetObjectTemplateField(locProto, "create", create);
	common::SetObjectTemplateLazyAccessor(locProto->InstanceTemplate(),
	                                      "updateInterval", get_updateInterval, set_updateInterval);
