...
Napi::Object osn::AudioTrack::Init(Napi::Env env, Napi::Object exports)
{
	...
	Napi::Function func = DefineClass(env, "AudioTrack",
					  {StaticMethod("create", &osn::AudioTrack::Create), StaticAccessor("audioTracks", &osn::AudioTrack::GetAudioTracks, nullptr), StaticAccessor("audioBitrates", &osn::AudioTrack::GetAudioBitrates, nullptr),
					   StaticMethod("getAtIndex", &osn::AudioTrack::GetAtIndex), StaticMethod("setAtIndex", &osn::AudioTrack::SetAtIndex),

					   InstanceAccessor("bitrate", &osn::AudioTrack::GetBitrate, &osn::AudioTrack::SetBitrate), InstanceAccessor("name", &osn::AudioTrack::GetName, &osn::AudioTrack::SetName), StaticMethod("importLegacySettings", &osn::AudioTrack::ImportLegacySettings),
