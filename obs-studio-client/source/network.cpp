...
Napi::Object osn::Network::Init(Napi::Env env, Napi::Object exports) {
	...
	Napi::Function func =
		...
		"Network",
		{
            ...
            InstanceAccessor(
                "bindIP",
                &osn::Network::GetBindIP,
                &osn::Network::SetBindIP),
            InstanceAccessor(
                "networkInterfaces",
                &osn::Network::GetNetworkInterfaces,
                nullptr),
            InstanceAccessor(
                "enableDynamicBitrate",
                &osn::Network::GetEnableDynamicBitrate,
                &osn::Network::SetEnableDynamicBitrate),
            InstanceAccessor(
                "enableOptimizations",
                &osn::Network::GetEnableOptimizations,
                &osn::Network::SetEnableOptimizations),
            InstanceAccessor(
                "enableLowLatency",
                &osn::Network::GetEnableLowLatency,
                &osn::Network::SetEnableLowLatency),
		});
...
osn::Network::Network(const Napi::CallbackInfo& info)
	: Napi::ObjectWrap<osn::Network>(info) {
...
Napi::Value osn::Network::Create(const Napi::CallbackInfo& info) {
	...
	std::vector<ipc::value> response =
		conn->call_synchronous_helper("Network", "Create", {});
